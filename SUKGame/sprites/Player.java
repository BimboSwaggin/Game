...
public class Player implements DisplayableSprite, MovableSprite, Health{
...
//**************************************************************************************************************************************************************************************************//
	...
	public Player(double centerX, double centerY, double height, double width) {
...
//-------------------------------------------------------------------------------//
		...
		if (keyboard.keyDown(70)) {
			setDirection(false, false, true);
			if (collidingBoss && isJumping == false) {
				universe.getBoss().isHit(true);	
			}
		}
		...
		if(hit) {
			this.health -= 1;
			if (universe.getBoss().getFacingDirection() > 0) {
				this.velocityX += 500;
